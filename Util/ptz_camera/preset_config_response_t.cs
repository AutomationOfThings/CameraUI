...
{
    public sealed class preset_config_response_t : LCM.LCM.LCMEncodable
    {
        ...
        public preset_config_response_t()
        {
        }
 
        public static readonly ulong LCM_FINGERPRINT;
        public static readonly ulong LCM_FINGERPRINT_BASE = 0x041a891d18e78c85L;
 
        static preset_config_response_t()
        {
        ...
        {
            if (classes.Contains("ptz_camera.preset_config_response_t"))
                return 0L;
 
            classes.Add("ptz_camera.preset_config_response_t");
        ...
        public preset_config_response_t(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public preset_config_response_t(LCMDataInputStream ins)
        {
        ...
        public static ptz_camera.preset_config_response_t _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            ptz_camera.preset_config_response_t o = new ptz_camera.preset_config_response_t();
        ...
        public ptz_camera.preset_config_response_t Copy()
        {
            ptz_camera.preset_config_response_t outobj = new ptz_camera.preset_config_response_t();
