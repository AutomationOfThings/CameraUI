...
{
    public sealed class preset_move_response_t : LCM.LCM.LCMEncodable
    {
        ...
        {
            if (classes.Contains("ptz_camera.preset_move_response_t"))
                return 0L;
 
            classes.Add("ptz_camera.preset_move_response_t");
        ...
        public preset_move_response_t(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public preset_move_response_t(LCMDataInputStream ins)
        {
        ...
        public static ptz_camera.preset_move_response_t _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            ptz_camera.preset_move_response_t o = new ptz_camera.preset_move_response_t();
        ...
        public ptz_camera.preset_move_response_t Copy()
        {
            ptz_camera.preset_move_response_t outobj = new ptz_camera.preset_move_response_t();
