...
{
    public sealed class ptz_control_response_t : LCM.LCM.LCMEncodable
    {
        public String ip_address;
        public String response_message;
 
        public ptz_control_response_t()
        {
        }
        ...
        {
            if (classes.Contains("ptz_camera.ptz_control_response_t"))
                return 0L;
 
            classes.Add("ptz_camera.ptz_control_response_t");
        ...
        public ptz_control_response_t(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public ptz_control_response_t(LCMDataInputStream ins)
        {
        ...
        public static ptz_camera.ptz_control_response_t _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            ptz_camera.ptz_control_response_t o = new ptz_camera.ptz_control_response_t();
        ...
        public ptz_camera.ptz_control_response_t Copy()
        {
            ptz_camera.ptz_control_response_t outobj = new ptz_camera.ptz_control_response_t();
